...
async function seedRooms(
  ...
  const roomsToCreate = [
    ...
    },
    {
      ...
      country: '일본',
      city: '오사카',
      address: '오사카시 나니와구 난바나카 2-10-70',
    ...
    },
    {
      ...
      country: '일본',
      city: '오사카',
      address: '오사카시 주오구 신사이바시스지 1-8-3',
    ...
    },
    {
      ...
      country: '일본',
      city: '오사카',
      address: '오사카시 텐노지구 차우스야마초 1-108',
    ...
    },
    {
      ...
      country: '일본',
      city: '오사카',
      address: '오사카시 아베노구 아베노스지 1-1-43',
